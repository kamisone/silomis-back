              ...
              ? {
                  personalizations: {
                    create: item.personalizations.map((d) => ({
                      ...
                      trackingPct: d.trackingPct,
                      kerning: (d.kerning ?? undefined) as Prisma.InputJsonValue,
                      curveDeg: d.curveDeg,
                      hasOutline: d.hasOutline,
                      outlineThread: (d.outlineThread ?? undefined) as Prisma.InputJsonValue,
                      isPuff: d.isPuff,
                      motifKey: d.motifKey,
                      motifName: d.motifName,
                      motifPath: d.motifPath,
                      motifViewBox: d.motifViewBox,
