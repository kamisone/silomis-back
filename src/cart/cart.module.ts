...
@Module({
  imports: [AssetUrlModule, TranslationsModule, EmailModule, CheckoutModule, DlqModule, AnalyticsTrackingModule, BullModule.registerQueue({ name: CART_ABANDONMENT_QUEUE })],
